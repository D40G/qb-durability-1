...
var GreenColor = "rgb(15, 255, 213)";
var RedColor = "rgb(4, 68, 101)";
var OrangeColor = "rgb(14, 111, 123)";
...
function FormatAttachmentInfo(data) {
    $.post(
        ...
        function(data) {
            ...
            if (Math.floor(ClickedItemData.info.quality)  !== undefined) {
                Durability = Math.floor(ClickedItemData.info.quality) ;
            }
        ...
        if (
                    ...
                    if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                        ...
                        $toInv
                            ...
                            if (newData.info.quality == 0) {
                                qualityLabel = "BROKEN";
                                $toInv.find("[data-slot=" + $toSlot + "]").addClass("RedBackGround");
                            }
                            ...
                            $toInv
                                ...
                                .find("p")
                                .html(qualityLabel);
                    $fromInv.find("[data-slot=" + $fromSlot + "]").removeClass("RedBackGround");
            ...
            if (fromData.amount == $toAmount) {
                ...
                var ItemLabel =
                    ...
                    // if (fromData.name.split("_")[0] !== "Randome") {
                ...
                var ItemLabel =
                   ...
                   // if (newDataTo.name.split("_")[0] !== "Randome") {
...
(() => {
    ...
    Inventory.QualityCheck = function(item, IsHotbar, IsOtherInventory) {
        //if (!Inventory.IsWeaponBlocked(item.name)) {
           // if (item.name.split("_")[0] !== "Randome" && item.price == undefined && item.costs == undefined) {
            ...
            $.each(data.inventory, function(i, item) {
                if (item != null) {
                    ...
                    var ItemLabel =
                        ...
                        //if (item.name.split("_")[0] !== "Randome") {
                            //if (!Inventory.IsWeaponBlocked(item.name)) {
                                ItemLabel =
                                    '<div class="item-slot-quality"><div class="item-slot-quality-bar"></div></div><div class="item-slot-label"><p>' +
                                    item.label +
                                    "</p></div>";
                            //}
                        //}
